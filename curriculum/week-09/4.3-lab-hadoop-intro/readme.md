...
2. Output the list words with the counts as output. You can also save that list to a file and read it into Pandas to sort the words by the most frequent.
